        ...
        <main className="flex-1">
            ...
            <div className="absolute inset-0 z-[2] pointer-events-none overflow-hidden">
              <div
                ...
                style={{
                  ...
                  backgroundSize:
                    "clamp(40px, 5vw, 80px) clamp(40px, 5vw, 80px)",
            ...
            >
                ...
                >
                  <MagneticButton strength={0.15}>
                    <button
                      ...
                      className="group relative flex items-center justify-center gap-2 rounded-xl h-13 px-8 bg-primary text-white text-sm font-semibold transition-all duration-300 hover:shadow-[0_0_40px] hover:shadow-primary/40 hover:-translate-y-0.5 active:translate-y-0 overflow-hidden"
                    >
                  ...
                  <MagneticButton strength={0.15}>
                    <button className="group flex items-center justify-center gap-2 rounded-xl h-13 px-8 bg-surface/50 border border-border backdrop-blur-sm text-white text-sm font-semibold transition-all duration-300 hover:bg-surface-hover hover:border-border-hover hover:-translate-y-0.5 active:translate-y-0">
                      <div className="relative w-5 h-5 rounded-full bg-surface-hover flex items-center justify-center group-hover:bg-surface-hover transition-colors">
              ...
              >
                <div className="relative">
                  ...
                  <InteractiveGlobe size={590} dark={true} />
                </div>
              </motion.div>
            </motion.div>
          ...
          <section className="relative z-20 -mt-16 px-4 md:px-10">
            <ScrollReveal variant="fadeUp" className="max-w-[1100px] mx-auto">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-px rounded-2xl overflow-hidden bg-border dark:bg-border-dark border border-border shadow-xl shadow-black/5">
                {stats.map((stat, i) => (
                  <div
                    key={i}
                    className="flex flex-col items-center gap-1 py-8 px-4 bg-surface text-center"
                  >
            ...
            <div className="max-w-[1100px] mx-auto">
              <div className="flex flex-col gap-4 text-center items-center mb-16">
                ...
                <ScrollReveal variant="fadeUp" delay={0.1}>
                  <h2 className="text-white text-3xl md:text-[2.75rem] font-bold leading-tight tracking-tight">
                ...
                {features.map((feature, i) => (
                  <StaggerItem key={i}>
                    <motion.div
                      ...
                      className="group relative flex flex-col gap-5 rounded-2xl border border-border bg-surface p-8 h-full cursor-pointer overflow-hidden transition-shadow"
                    >
                      {/* Hover gradient */}
          ...
          {/* ========== DASHBOARD PREVIEW ========== */}
          <section className="px-4 md:px-10 py-20 bg-surface/30 border-y border-border">
            <div className="max-w-[1100px] mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
              <div className="flex-1 flex flex-col gap-6">
                ...
                <ScrollReveal variant="fadeUp" delay={0.1}>
                  <h2 className="text-white text-3xl md:text-[2.5rem] font-bold leading-tight tracking-tight">
                    See your impact
                    <br />
                    in real-time.
                  </h2>
                ...
                <ScrollReveal variant="fadeUp" delay={0.15}>
                  <p className="text-slate-400 text-base leading-relaxed max-w-md">
                    ...
                    performance across all facilities. Identify hotspots
                    instantly and simulate reduction strategies.
                  </p>
                </ScrollReveal>
              ...
              >
                <div className="relative group">
                  ...
                  <div className="relative rounded-2xl overflow-hidden border border-border bg-background shadow-2xl shadow-black/[0.08]">
                    ...
                    >
                      <div className="p-4 bg-surface/95 backdrop-blur-xl rounded-xl border border-border/80 shadow-lg">
            ...
            >
              <div className="flex flex-col items-center gap-6">
                ...
                <p className="text-slate-400 text-base max-w-md leading-relaxed">
                  Get a personalized demo of Carbon-Trace and see how we can
                  help your organization reach its sustainability targets.
                </p>

                <div className="flex w-full max-w-md gap-2 mt-2">
                  <input
                    className="flex-1 h-12 px-4 rounded-xl bg-surface border border-border focus:border-primary focus:ring-2 focus:ring-primary/20 text-foreground text-white text-sm outline-none transition-all placeholder:text-muted-foreground"
                  ...
                  <MagneticButton strength={0.1}>
                    <button
                      onClick={() => navigate("/upload")}
                      className="h-12 px-6 bg-primary hover:bg-primary/90 text-white font-semibold text-sm rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-primary/25 whitespace-nowrap"
                    >
                      Get Started
                    </button>
                  </MagneticButton>
